...
package com.meditext.rakesh.meditext.vuforiaApp;
...
import com.meditext.rakesh.meditext.R;


public class VuforiaAppSession implements UpdateCallbackInterface
{
    
    private static final String LOGTAG = "MediText Session";
    ...
    public VuforiaAppSession(VuforiaAppControl sessionControl)
    {
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mShutdownLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "");
