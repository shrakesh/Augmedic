...
import com.meditext.rakesh.meditext.vuforiaApp.*;
import com.meditext.rakesh.meditext.vuforiaApp.utils.SampleApplicationGLView;
import com.meditext.rakesh.meditext.vuforiaApp.utils.SampleUtils;
import com.meditext.rakesh.meditext.vuforiaApp.utils.LoadingDialogHandler;
import com.meditext.rakesh.meditext.R;
import com.meditext.rakesh.meditext.TextRecoRenderer.WordDesc;

public class TextReco extends Activity implements VuforiaAppControl//,SampleAppMenuInterface
{
...
/*
   ...
   //             .getLayoutParams();
    ...
    public boolean doLoadTrackersData()
    {
      ...
      //  wl.addWordU( "creo" );
      //  wl.addWordU( "windchill" );

        wl.setFilterMode(WordList.FILTER_MODE.FILTER_MODE_WHITE_LIST);

        //if(ret != -1)
        wl.loadFilterList("TextReco/FilterWords.lst",
                 STORAGE_TYPE.STORAGE_APPRESOURCE);

        //wl.addWordToFilterListU( "creo" );
        //wl.addWordToFilterListU( "reality" );
